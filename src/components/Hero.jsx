      ...
      <div className="container mx-auto text-center">
        ...
        <div className="relative z-10">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
            Join the revolution with AmiCoin - a next-generation cryptocurrency
            designed for the modern world. Secure, fast, and built for everyone.
          </p>
          ...
          <div className="mt-16">
            <h2 className="text-2xl font-bold mb-8 text-[#e5e7eb]">
              Listed On
            </h2>
            <div className="flex flex-wrap justify-center gap-4 max-w-6xl mx-auto">
                      ...
                      >
                        <g clip-path="url(#clip0_208_2702)">
                          ...
                          <g clip-path="url(#clip2_208_2702)">
                            ...
                            />
                            <path
                              d="M249.526 118.861C265.207 125.129 322.468 144.201 347.242 151.687C321.947 109.715 283.614 112.137 249.526 118.861Z"
                              fill="#35AF00"
                            />
                            <path
                              d="M238.03 191.918L203.541 168.926V214.91L238.03 191.918Z"
                              fill="white"
                            />
                          </g>
                        </g>
              ...
              <div className="w-[160px]">
                <div className="bg-[#1a2e2a]/60 backdrop-blur-md border border-[#FFD700]/30 rounded-xl p-4 transition-all duration-300 hover:bg-[#1a2e2a]/80 hover:border-[#FFEE58] hover:shadow-lg hover:shadow-[0_0_20px_rgba(255,238,88,0.3)] transform hover:-translate-y-2 hover:scale-105 h-full">
                  <div className="flex flex-col items-center h-full">
                    <div className="mb-4 flex items-center justify-center h-12">
                      <img
                        src="/src/assests/images/van.png"
                        alt="Vindax Logo"
              ...
              <div className="w-[160px]">
                <div className="bg-[#1a2e2a]/60 backdrop-blur-md border border-[#FFD700]/30 rounded-xl p-4 transition-all duration-300 hover:bg-[#1a2e2a]/80 hover:border-[#FFEE58] hover:shadow-lg hover:shadow-[0_0_20px_rgba(255,99,71,0.3)] transform hover:-translate-y-2 hover:scale-105 h-full">
                  <div className="flex flex-col items-center h-full">
                    <div className="mb-4 flex items-center justify-center h-12">
                      <img
                        src="/src/assests/images/koin.png"
                        alt="koinbazar Logo"
                        className="h-full object-contain"
                      />
                    </div>
              ...
              <div className="w-[160px]">
                <div className="bg-[#1a2e2a]/60 backdrop-blur-md border border-[#FFD700]/30 rounded-xl p-4 transition-all duration-300 hover:bg-[#1a2e2a]/80 hover:border-[#FFEE58] hover:shadow-lg hover:shadow-[0_0_20px_rgba(255,99,71,0.3)] transform hover:-translate-y-2 hover:scale-105 h-full">
                  <div className="flex flex-col items-center h-full">
                    {/* **Logo Container - Adjusted for SVG Visibility** */}
                    <div className="mb-4 flex items-center justify-center h-12 w-full p-2 bg-white">
                      <img
                        src="/src/assests/images/bsc.svg"
                        alt="BscScan Logo"
              ...
              <div className="w-[160px]">
                <div className="bg-[#1a2e2a]/60 backdrop-blur-md border border-[#FFD700]/30 rounded-xl p-4 transition-all duration-300 hover:bg-[#1a2e2a]/80 hover:border-[#FFEE58] hover:shadow-lg hover:shadow-[0_0_20px_rgba(255,99,71,0.3)] transform hover:-translate-y-2 hover:scale-105 h-full">
                  <div className="flex flex-col items-center h-full">
                    {/* **Logo Container - Adjusted for SVG Visibility** */}
                    <div className="mb-4 flex items-center justify-center h-12 w-full p-2 ">
                      <img
                        src="/src/assests/images/block1.png.webp"
                        alt="Blockspot Logo"
                        className="h-full w-auto max-w-full"
                      />
                    </div>
